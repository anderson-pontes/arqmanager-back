...
def migrate_servicos(mysql_session, pg_session):
    ...
    for row in result:
        try:
            ...
            print(f"⚠️  Erro ao migrar serviço {row[0]}: {e}")
    
    pg_session.commit()
    print(f"✅ {count} serviços migrados")
...
def migrate_etapas(mysql_session, pg_session):
    ...
    for row in result:
        try:
            ...
            print(f"⚠️  Erro ao migrar etapa {row[0]}: {e}")
    
    pg_session.commit()
    print(f"✅ {count} etapas migradas")
...
def migrate_propostas(mysql_session, pg_session):
    ...
    for row in result:
        try:
            ...
            print(f"⚠️  Erro ao migrar proposta {row[0]}: {e}")
    
    pg_session.commit()
    print(f"✅ {count} propostas migradas")
...
def migrate_projetos(mysql_session, pg_session):
    ...
    for row in result:
        try:
            ...
            print(f"⚠️  Erro ao migrar projeto {row[0]}: {e}")
    
    pg_session.commit()
    print(f"✅ {count} projetos migrados")
...
def migrate_movimentos(mysql_session, pg_session):
    ...
    for row in result:
        try:
            ...
            print(f"⚠️  Erro ao migrar movimento {row[0]}: {e}")
    
    pg_session.commit()
    print(f"✅ {count} movimentos migrados (limitado a 1000)")
